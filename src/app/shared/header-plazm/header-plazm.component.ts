...
@Component({
  selector: 'app-header-plazm',
  templateUrl: './header-plazm.component.html',
  styleUrls: ['./header-plazm.component.scss']
})
export class HeaderPlazmComponent implements AfterViewInit {
